		...
		<div class="container bootstrap snippets bootdey">
			<div class="row">
				...
				<div class="col-md-9 text-content">
					<center>보낸 쪽지: ${listcount}개</center>
					<table align="center" width=800 class="table">
						<c:forEach var="s" items="${sendlist}">
							<tr>
								<td width="70%"><a
									href="messagesendview.do?mno=${s.mno}&page=${page}">
										${s.msubject} </a></td>
								<td>${s.rcvid}</td>
								<td><fmt:formatDate value="${s.mdate}"
					...
					<center>
						<c:if test="${listcount > 0}">
							...
							<!-- 1page로 이동 -->
							<a href="sendlist.do?page=1" style="text-decoration: none"> <
							</a>
				...
				[${i}]
							...
							<!-- 마지막 페이지로 이동 -->
							<a href="sendlist.do?page=${pageCount}"
