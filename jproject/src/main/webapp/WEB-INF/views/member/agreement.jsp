	...
	<section class="sample-text-area">
		...
		<div class="col-md-6">
				...
				<form name="myform" id="myform">
					<tr>
						<td height="70%" align="center"><br>
							<a href="home.do">JEJU FRIEND</a></span> <br>
						<br>
					</tr>

					<tr>
						<td><input type="checkbox" id="checkall" /><b>JEJU
								FRIEND 모든 이용약관에 동의합니다.</b></td>
					</tr>
					<tr>
						<td><textarea name="" id="" cols=100 rows=4>여러분을 환영합니다.
			...
			JEJU FRIEND의 서비스를 이용해 주셔서 감사합니다. 본 약관은 다양한 JEJU FRIEND의 서비스의 이용과 관련하여 JEJU FRIEND의 서비스를 제공하는 TEAM3 주식회사(이하 ‘TEAM3’)와 이를 이용하는 JEJU FRIEND 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 JEJU FRIEND의 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
					...
					<tr>
						<td><input type="checkbox" name="chk" />개인정보 수집 및 이용에 대한 안내
							동의</td>
					</tr>
					<tr>
						<td><textarea name="" id="" cols=100 rows=4>여러분을 환영합니다.
			...
			JEJU FRIEND의 서비스를 이용해 주셔서 감사합니다. 본 약관은 다양한 JEJU FRIEND의 서비스의 이용과 관련하여 JEJU FRIEND의 서비스를 제공하는 TEAM3 주식회사(이하 ‘TEAM3’)와 이를 이용하는 JEJU FRIEND 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 JEJU FRIEND의 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
					...
					<tr>
						<td><input type="checkbox" name="chk" />이벤트 등 프로모션 알림 메일 수신
							동의</td>
					</tr>
					<tr>
						<td align="center" valign="top"><input type="button"
							value="취소" onclick="nocheck()" />&nbsp;&nbsp;&nbsp; <input
							type="button" value="확인" onclick="check()" /></td>
					</tr>
				</form>
			</table>
			</div>
