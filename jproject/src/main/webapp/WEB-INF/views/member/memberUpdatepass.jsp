		...
		<div class="container bootstrap snippets bootdey">
			<div class="row">
				...
				<div class="col-md-9 text-content">
					<div id="join_wrap">
						<form name="f" method="post" action="MemberUpdatepass.do"
					...
					<td>${edit.id}</td>
								...
								<tr>
									...
									<td><input type="password" name="passwd" id="passwd"
										size="14" value="${mb.nickname}" class="input_box" /></td>
								</tr>
								<tr>
									<th>새 비밀번호</th>
							...
							<div id="join_menu">
								<input type="submit" value="비밀번호 변경" class="input_button" /> <input
