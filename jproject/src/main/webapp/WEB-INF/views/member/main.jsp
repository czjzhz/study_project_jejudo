			...
			<div class="navbar-collapse" id="navbar-collapse">
				...
				<div class="nav-login">
					...
					<script>
						...
						<a href="" title=""><i class="fa fa-user-plus"></i> 여행 동행찾기</a></li>
						<a href="" title=""><i class="fa fa-pencil"></i> 여행 리뷰</a></li>
						<a href="" title=""><i class="fa fa-tree"></i> 여행 추천 장소</a></li>
						<a href="qboardlist.do" title=""><i class="fa fa-question-circle"></i> 여행 Q&A</a>
						<a href="" title=""><i class="fa fa-bullhorn"></i> 공지사항</a>
					<!-- 	<a href="calendargo.do" title=""><i class="fa fa-bullhorn"></i> 여행 일정</a> -->
					</c:if>
					
					<!-- 세션 있는 경우 -->
					<c:if test="${sessionScope.id != null }">
						<a href="./MemberLogout.do"><i class="fa fa-unlock"></i>로그아웃</a>
						<a href=""><i class="fa fa-mypage"></i>마이페이지</a>
						<a href="" title=""><i class="fa fa-user-plus"></i> 여행 동행찾기</a></li>
						<a href="" title=""><i class="fa fa-pencil"></i> 여행 리뷰</a></li>
						<a href="" title=""><i class="fa fa-tree"></i> 여행 추천 장소</a></li>
						<a href="qboardlist.do" title=""><i class="fa fa-question-circle"></i> 여행 Q&A</a>
