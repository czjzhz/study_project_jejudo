		...
		<div id="main_wrap">
			...
			<form method="post" action="MemberLogout.do">
				<table id="main_t" border="1">
					...
					<tr>
						<th colspan="2">
						<input type="button" value="프로필 편집" class="input_button" onclick="location='MemberUpdate.do'" /> 
						...
						<input type="button" value="메인페이지로 돌아가기" class="input_button" onclick="location='home.do'" /></th>
					</tr>
				</table>
